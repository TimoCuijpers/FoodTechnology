        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden sm:rounded-lg bg-gray-100">
                <div class="grid grid-cols-3 grid-rows-1 w-6/7 mx-auto">
                    <div><h1 class="mt-10 mb-16 text-4xl font-bold">Devices</h1></div>
                    <div></div>
                </div>
                
                <div class="grid grid-cols-3 grid-rows-3 w-6/7 mx-auto border-collapse gap-10 text-center">
                    <div class="border rounded-md bg-white">
                        <a href="">
                            <img src="{{ asset('img/DoABarrelRoll.png') }}" alt="" class="h-[150px] mx-auto">
                            <p class="pt-4">
                                Your water storage
                            </p>
                    ...
                    <div class="border rounded-md bg-white">
                        <a href="">
                            <img src="{{ asset('img/LogoBrabantWater.png') }}" alt="" class="h-[150px] w-auto mx-auto">
                            <p class="py-4">
                                Public water usage
                            </p>
                        </a>
